...
<tr>
  <td width='800' height="300" valign="top" style="padding:20px 10px 0 10px;">
   ...
   <div align="center" style="margin: 0 0 25px 0; padding: 2px 2px 2px 2px;"></div>  
	...
	<div align="left"  style="margin: 0 0 0 250px;">	
		<p class='tituloTermo'>TERMO DE COMPROMISSO DE ESTÁGIO NÃO OBRIGATÓRIO, QUE ENTRE SI
	...
	Ministério da Agricultura, Pecuária e Abastecimento, criada por força da Lei nº 5.851, de 07.12.72, com
	 Estatuto Social aprovado pelo Decreto nº 2.291, de 04.08.97, por intermédio de sua Unidade <b>Embrapa Informática
	  ...
	  data de nascimento <?php echo linha(formata(linha($estagiario['data_nascimento'],'gra'),'redata'),'data'); ?>, portador do 
	  RG nº <?php echo linha($estagiario['rg'],'med'); ?>, Órgão Expedidor: <?php echo linha($estagiario['orgao_expedidor'],'peq'); ?> , 
	  data de expedição: <?php echo linha(formata(linha($estagiario['data_expedicao'],'gra'),'redata'),'data'); ?>, inscrito no CPF/MF sob o N°
	  <?php echo linha($estagiario['cpf'],'med')?>, residente e domiciliado em (Cidade/Estado) 
	  <?php echo linha($estagiario['municipio'],'gra'); ?>-<?php echo linha($estagiario['uf'],'peq'); ?>, 
	  endereço <?php echo linha($estagiario['endereco'],'gra'); ?>, 
	   doravante designado simplesmente <b>Estudante</b>, com a interveniência da <b>Instituição de Ensino</b>
	    <?php echo linha($estagiario['instituicao'],'gra'); ?>, inscrita no CNPJ/MF sob o
	     ...
	     (Reitor/Diretor etc.) <?php echo linha($estagiario[''],'gra'); ?>, nome do representante legal
	      ...
	      Ensino, resolveram celebrar o presente TERMO DE COMPROMISSO DE ESTÁGIO NÃO OBRIGATÓRIO, que será 
  ...
  <div align="left" id="corpo2">	
	...
	<?php echo linha(substr($estagiario['inicio_curso'],0,4),'med'); ?> e com sua conclusão prevista para o  
	<?php echo linha(substr($estagiario['termino_curso'],6,1),'peq')."º"; ?>  semestre do ano de
	...
	<br><br>
		...
		educacional e à sua preparação para o trabalho produtivo, com sua efetiva atuação nas atividades pertinentes
		 à área de <?php echo linha($estagiario['area_atuacao'],'med'); ?>, junto ao Órgão/Departamento/Setor: 
		 <?php echo linha($estagiario['projeto_setor'],'med'); ?> de 
	...
	<br><br>
	<span class="paragrafoTermo">O <b>Estudante</b> obriga-se a cumprir uma jornada de atividade de 
	<?php echo linha(floor($estagiario['carga_horaria']/5),'peq'); ?> (<?php echo linha(extenso(floor($estagiario['carga_horaria']/5)),'med'); ?>) horas diárias
	 e <?php echo linha($estagiario['carga_horaria'],'peq'); ?> (<?php echo linha(extenso($estagiario['carga_horaria']),'med'); ?>) horas semanais, nos seguintes horários _ _ _ _ _ _.</span>
...
<?php 
	...
	<div style="padding: 0px 0px 0px 30px;">
		...
		<table><tr><td valign="top"><b><span class="corpoTermo">i)</span></b></td><td><span class="corpoTermo">não receber bolsa de outra instituição, enquanto estiver realizando estágio não obrigatório na <b>Embrapa</b>;</span></td></tr></table>
		<table><tr><td valign="top"><b><span class="corpoTermo">j)</span></b></td><td><span class="corpoTermo">observar a regulamentação interna da <b>Embrapa</b> no exercício de suas atividades, conforme orientação do empregado supervisor. </span></td></tr></table>
	</div>
	</p>	
	<p class="corpoTermo">
...
<?php 
	...
	<br><br>
	<b>CLÁUSULA NONA – Dos benefícios</b>
	<br><br>
	<span class="paragrafoTermo">A <b>Embrapa</b> concederá, mensalmente, como contraprestação pela execução de suas atividades, uma bolsa de estágio ao <b>Estudante</b> no valor de R$ <?php echo linha($estagiario['remuneracao'],'gra'); ?> (<?php echo extenso(linha($estagiario['remuneracao'],'gra')); ?> reais), paga de acordo com a carga horária fixada na cláusula terceira deste Termo de Compromisso e a freqüência em suas atividades. </span>
	<br><br>
	<b>SUBCLÁUSULA PRIMEIRA:</b> A bolsa de estágio será paga diretamente ao <b>Estudante</b> até o 10º (décimo) dia útil do mês subseqüente ao vencido, em conformidade com a freqüência apurada no mês de referência.
	<br><br>
	<b>SUBCLÁUSULA SEGUNDA:</b> Além da bolsa de estágio, a <b>Embrapa</b> concederá ao <b>Estudante</b> auxílio-transporte pecuniário ou transporte coletivo regular em seus ônibus.
	<br><br>
	<b>SUBCLÁUSULA TERCEIRA:</b> A concessão dos benefícios previstos nesta cláusula não caracteriza vínculo de empregado.
	<br><br>
	<b>CLÁUSULA DÉCIMA – Do Recesso Remunerado</b>
	<br><br>
	<span class="paragrafoTermo">É assegurado ao <b>Estudante</b>, sempre que o estágio tenha duração igual ou superior a 1 (um) ano, um período de recesso remunerado de 30 (trinta) dias, a ser gozado preferencialmente durante suas férias escolares.</span>
	<br><br>
	...
	<div align="left" id="corpox">
	<p class="corpoTermo">
	<b>CLÁUSULA DÉCIMA PRIMEIRA – Do certificado de estágio</b>
	<br><br>
	<span class="paragrafoTermo">Ao término do estágio com aproveitamento, a Embrapa emitirá o correspondente certificado de estágio, do qual constará:</span>	
	</p>
	...
	<div style="padding: 0px 0px 0px 30px;">
		...
		<table><tr><td valign="top"><b><span class="corpoTermo">f)</span></b></td><td><span class="corpoTermo">relatório do projeto, caso o Estudante esteja vinculado a algum.</span></td></tr></table>
	</div>
	</p></div>

<div align='left' id='corpoy'>
	<p class="corpoTermo">
	<b>CLÁUSULA DÉCIMA SEGUNDA – Da Vigência</b>
	<br><br>
	...
	com início em <?php echo linha(formata($estagiario['vigencia_inicio'],'redata'),'gra'); ?> e término
	 em <?php echo linha(formata($estagiario['vigencia_fim'],'redata'),'gra'); ?>, podendo ser prorrogado, no interesse das partes, 
	...
	<br><br>
	<b>CLÁUSULA DÉCIMA TERCEIRA – Da Rescisão</b>
	<br><br>
...
<?php 
	...
	<p class="corpoTermo">
	<b>CLÁUSULA DÉCIMA QUARTA – Da Denúncia</b>
	<br><br>
	...
	<br><br>
	<b>CLÁUSULA DÉCIMA QUINTA – Do Foro</b>
	<br><br>

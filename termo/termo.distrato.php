  ...
  <td width='800' height="300" valign="top" style="padding:20px 10px 0 10px;">
   ...
   <div align="center" style="margin: 0 0 25px 0; padding: 2px 2px 2px 2px;"></div>  
	...
	<div align="left"  style="margin: 0 0 0 250px;">	
		<p class='tituloTermo'>TERMO DE DISTRATO AO TERMO DE COMPROMISSO DE ESTÁGIO FIRMADO EM 
		<?php echo linha(formata($estagiario['vigencia_inicio'],'redata'),'data'); ?>, QUE ENTRE SI CELEBRAM A EMPRESA BRASILEIRA DE PESQUISA AGROPECUÁRIA – EMBRAPA E O 
		ALUNO <?php echo linha($estagiario['nome'],'gra'); ?>, COM INTERVENIÊNCIA DA INSTITUIÇÃO DE 
		ENSINO <?php echo linha($estagiario['instituicao'],'gra'); ?></p>
	</div>	
	...
	Ministério da Agricultura, Pecuária e Abastecimento, criada por força da Lei nº 5.851, de 07.12.72, com
	 Estatuto Social aprovado pelo Decreto nº 2.291, de 04.08.97, por intermédio de sua Unidade <b>Embrapa Informática
	  ...
	  data de expedição: <?php echo formata(linha($estagiario['data_expedicao'],'med'),'redata'); ?>, inscrito no CPF/MF sob o N°
	  ...
	  <?php echo linha($estagiario['municipio'],'gra')?>-<?php echo linha($estagiario['uf'],'peq')?>, endereço <?php echo linha($estagiario['endereco'],'gra')?>, 
	   doravante designado simplesmente <b>Estagiário</b>, com a interveniência da <b>Instituição de Ensino</b>
	    <?php echo linha($estagiario['instituicao'],'gra'); ?>, inscrita no CNPJ/MF sob o
	     ...
	     (Reitor/Diretor etc.) <?php echo linha($estagiario[''],'gra'); ?>, nome do representante legal
	      ...
	      Ensino, resolvem celebrar o presente TERMO DE DISTRATO ao TERMO DE COMPROMISSO DE
	       ESTÁGIO, na forma das seguintes cláusulas e condições:
	 </div>
	 <div align="left" id="corpo2">	
	<p class="corpoTermo">      
	<b>CLÁUSULA PRIMEIRA – Do distrato</b>
	<br><br>
	<span class="paragrafoTermo">As partes, a partir da assinatura deste instrumento, resolvem distratar o 
	TERMO DE COMPROMISSO DE ESTÁGIO por elas celebrado em <?php echo linha(formata($estagiario['vigencia_inicio'],'redata'),'data'); ?>.</span>
	<br><br>
	<b>SUBCLÁUSULA ÚNICA:</b> As partes conferem, mutuamente, plena e geral quitação das obrigações constantes do TERMO DE COMPROMISSO DE ESTÁGIO ora distratado.
	<br><br></p>
<?php 
		rodapeTermo();	
		echo "<br>";
 	...
 	?>				
	<p class="corpoTermo">
	<span class="paragrafoTermo">E, por estarem assim ajustadas, as partes firmam o presente instrumento em 03 
	(três) vias de igual teor e forma, na presença das duas testemunhas abaixo nomeadas e subscritas.</span>
	<br><br><br>		

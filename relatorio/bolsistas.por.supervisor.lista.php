...
<div align='center'>
    <span class='titulo'>Relação de Bolsistas por Supervisor</span><br>
...
<tr><td>&nbsp;</td></tr>
<tr align='center'><td>
<a onclick="window.open('relatorio.bolsistas.por.supervisor.print.php','relatorio print','width=850,height=700,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,copyhistory=yes,resizable=no');" style="color: rgb(0, 0, 255); font-size: 14px;" href="javascript://">
